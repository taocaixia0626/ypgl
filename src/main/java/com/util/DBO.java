...
public class DBO {
	...
	//static String url = "jdbc:mysql://127.0.0.1:3306/systemweb?characterEncoding=utf-8&useSSL=false&serverTimezone=Asia/Shanghai";  //mysql8链接地址
	static String url = "jdbc:mysql://localhost:3306/00_demo?useUnicode=true&characterEncoding=UTF8&useInformationSchema=true&remarks=true";
	static String user = "root";
	static String pwd = "t187c2699x8316";
