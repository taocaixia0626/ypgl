...
<form action=<%=basePath %>admin/tong/search.jsp method=post name=form1 onSubmit="return jiancha()">
		<TABLE width="100%" border=0 align="center" cellPadding=3 cellSpacing=1 class=tablewidth>
		  ...
		  <TR align="center">
			<TD height=23>开始日期：
			<input type=text name=stime  onclick="SelectDate(this,'yyyy-MM-dd')"  this.Txt_Date.Attributes["onclick"] = "SelectDate(this,'yyyy-MM-dd')";>
			截至日期：<input type=text name=etime  onclick="SelectDate(this,'yyyy-MM-dd')"  this.Txt_Date.Attributes["onclick"] = "SelectDate(this,'yyyy-MM-dd')";> 
